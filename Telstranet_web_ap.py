...
loaded_model=pickle.load(open('C:/Users/hp/Pictures/Telstramodel_deplyment/trained_model_lgg.sav','rb'))
loaded_model1=pickle.load(open('C:/Users/hp/Pictures/Telstramodel_deplyment/pcaa.sav','rb'))
nrows=100
data=pd.read_csv("C:/Users/hp/Pictures/Telstramodel_deplyment/newdata.csv",nrows=nrows)
X=pd.read_csv("C:/Users/hp/Pictures/Telstramodel_deplyment/newaa1.csv")
y=pd.read_csv("C:/Users/hp/Pictures/Telstramodel_deplyment/newyA.csv")
cal=pickle.load(open('C:/Users/hp/Pictures/Telstramodel_deplyment/cali.sav','rb'))

#Creating a function for prediction
def telstranet_disruption_prediction(Id1,event_type1,log_feature1,volume1,resource_type1,severity_type1):
   id1=str(Id1)
   id=module.preproccesing(id1)
   if (id=='enter a valid value'):
   ...
   if (severity1=='enter a valid value'):
     return 'enter a valid value'
   v1=str(volume1)
   volume=module.preproccesing(v1)
   ...
   pr=[id,event_type,log_feature,volume,resource_type1,resource_type10,resource_type2,resource_type3,resource_type4,resource_type5,resource_type6,resource_type7,resource_type8,resource_type9,severity_type1,severity_type2,severity_type3,severity_type4,severity_type5]
   print(pr)
...
vv=telstranet_disruption_prediction(1234,'event_type 2','feature 203',3,'resource_type 6','severity_type 2')
print(vv)
...
def main():
    ...
    Id=st.number_input(label='id number',min_value=0)
